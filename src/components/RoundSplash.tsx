...
export const RoundSplash: React.FC<RoundSplashProps> = ({ round }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col items-center justify-center text-center p-8 animate-fadeIn">
      {/* Round Badge */}
      <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-cyan-500/20 border-2 border-cyan-400/60 text-cyan-300 font-black uppercase tracking-widest text-sm sm:text-base mb-6 shadow-[0_0_20px_rgba(6,182,212,0.4)]">
      ...
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-5 w-full max-w-2xl">
        <div className="p-6 rounded-3xl bg-[#111827]/90 border-2 border-amber-500/50 shadow-[0_0_25px_rgba(245,158,11,0.25)] flex flex-col items-center">
        ...
        <div className="p-6 rounded-3xl bg-[#111827]/90 border-2 border-purple-500/50 shadow-[0_0_25px_rgba(168,85,247,0.25)] flex flex-col items-center">
      ...
      <div className="mt-10 flex items-center gap-2 text-sm text-gray-400 animate-bounce font-medium">
        <span>Aguarde o sorteio na roleta pelo moderador</span>
